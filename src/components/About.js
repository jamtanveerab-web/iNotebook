...
const About = () => {
  return (
    <div className='mt-5' >
      <p style={{ color: "#0087ff", fontFamily: "Inter,'FontAwesome', sans-serif", fontSize: "12px", letterSpacing: "2px" }}>  ABOUT INOTEBOOK</p>
      <div className=' container'>
        <div className="container  mt-5 ">
          <div className="hero-badge text-center mb-5">
            ...
            <h4 style={{ color: "#6A7282" }}>iNotebook started as a personal frustration project. Every tool we tried was<br /> either too powerful or too shallow. So we built something in the middle —<br /> structured enough to be useful, minimal enough to stay out of the way.</h4>
          </div>
          <div className="d-flex justify-content-center text-center" style={{ backgroundColor: "#F9FAFB" }}>
            <div className="mx-4">
...
<div className="text-center"><h1>"The best tool is the one you actually use."</h1><br/> <span>— The iNotebook team</span></div>
        </div>
      </div>
      <Footer/>
    </div>
